...
Text::Text(const std::string& fontPath, int fontSize) : vao(0), vbo(0)
{
...
void Text::renderText(Shader& shader, std::string text, glm::vec2 screenPos, float scale, glm::vec3 color)
{
	shader.useShader();
